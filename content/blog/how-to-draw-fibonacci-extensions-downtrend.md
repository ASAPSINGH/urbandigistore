...
1.  **Point A (The Swing High)**: The absolute peak where the bearish leg began.
2.  **Point B (The Swing Low)**: The bottom of the initial downward dump before a minor bounce.
3.  **Point C (The Retracement High)**: The peak of the relief rally bounce where buyers failed and selling resumed.
...
1.  **Click Point A**: Select the wick peak of the major **Swing High**.
2.  **Click Point B**: Drag down and click on the wick bottom of the **Swing Low**.
3.  **Click Point C**: Drag back up and click on the peak of the **Retracement High**.
...
To learn more about upside targets, read [How to Draw Fibonacci Extensions for Upside Profit Targets](/blog/how-to-draw-fibonacci-extensions). To set stop-losses, review [Bear Market Retracements](/blog/fibonacci-retracement-bear-market) or calculate levels using the [Fibonacci Calculator](/fibonacci-calculator).
