...
To construct an arc:
1.  A baseline is drawn between a major **Swing Low** and a **Swing High**.
2.  The Swing High acts as the center point of the circles.
3.  Concentric circles are drawn outwards, with their radii corresponding to 38.2%, 50%, and 61.8% of the baseline's length.
...
2.  **Anchor 2**: Drag your cursor and click on the absolute **Swing High** wick (the peak of the impulse).
...
2.  **Anchor 2**: Drag your cursor and click on the absolute **Swing Low** wick (the bottom of the consolidation).
