...
1.  **Anchor 1**: Select your charting library's Fibonacci Retracement tool and click on the absolute wick peak of the **Swing High**.
2.  **Anchor 2**: Drag the cursor down and to the right, clicking on the absolute wick bottom of the **Swing Low**.
...
To protect your capital when shorting:
1.  **Stop-Loss Placement**: Set your stop-loss order slightly above the **0.786 retracement level**. If the price rises past 0.786, the bearish trend structure is invalid.
2.  **Size Your Position**: Use a [Position Size Calculator](/position-size-calculator) to ensure that your risk distance matches your budget.
3.  **Target Extensions**: Once your short entry is filled at the 0.618 level, use [Fibonacci Extensions](/blog/fibonacci-extensions-profit-targets) to plot profit targets below the previous Swing Low.

For a comparison of bullish setups, check out our [Uptrend Fibonacci Retracement Guide](/blog/fibonacci-retracement-trading-guide) or play around with the settings on our [Fibonacci Calculator Tool](/fibonacci-calculator).
