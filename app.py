...
TOOL_BLOG_MAPPING = {
    ...
    'qr-generator': ['how-to-generate-custom-qr-codes', 'demystifying-qr-code-masking-scanning-speed', 'demystifying-qr-code-versions-grid-dimensions', 'demystifying-qr-code-color-contrast-scannability', 'demystifying-qr-code-quiet-zones-scan-reliability', 'demystifying-qr-code-error-correction-levels', 'demystifying-qr-code-mask-penalty-calculation', 'demystifying-qr-code-version-scaling-grid-dimensions', 'demystifying-qr-code-color-contrast-scannability-rules', 'demystifying-qr-code-quiet-zones-scan-boundaries'],
    'password-generator': ['cryptographically-secure-passwords-entropy-math', 'password-length-entropy-exponent-comparison', 'why-password-managers-are-critical-security', 'why-password-hashing-requires-salt-rainbow-tables', 'why-master-password-kdf-iterations-matter', 'why-browser-passwords-are-vulnerable-standalone-vaults', 'why-password-salts-must-be-cryptographically-random', 'why-password-hashing-requires-salt-dict-attacks', 'why-password-hashing-requires-salt-rainbow-lookups', 'why-browser-passwords-are-vulnerable-security-vaults'],
    'merge-pdf': ['how-to-merge-pdf-documents-locally', 'understanding-pdf-document-margins', 'understanding-pdf-font-embedding-subsetting', 'understanding-pdf-metadata-xmp-catalog', 'understanding-pdf-linearization-fast-web-view', 'understanding-pdf-structural-security-passwords', 'understanding-pdf-font-embedding-subsetting-standards', 'understanding-pdf-structural-security-passwords-access'],
    'split-pdf': ['how-to-split-pdf-pages-locally', 'pdf-page-splitting-range-syntax-extraction', 'understanding-pdf-document-margins', 'understanding-pdf-font-embedding-subsetting', 'understanding-pdf-metadata-xmp-catalog', 'understanding-pdf-linearization-fast-web-view', 'understanding-pdf-structural-security-passwords', 'understanding-pdf-font-embedding-subsetting-standards', 'understanding-pdf-structural-security-passwords-access'],
    'position-calculator': ['stop-loss-sizing-portfolio-risk-two-percent', 'stop-loss-sizing-average-true-range-atr', 'stop-loss-options-premium-volatility', 'stop-loss-position-sizing-atr-multipliers', 'stop-loss-sizing-volatility-adjusted-atr', 'stop-loss-position-sizing-maximum-drawdown', 'stop-loss-position-sizing-kelly-criterion', 'stop-loss-position-sizing-vix-volatility', 'stop-loss-position-sizing-sharpe-ratio', 'stop-loss-position-sizing-sharpe-sortino', 'stop-loss-position-sizing-ulcer-index', 'stop-loss-position-sizing-sortino-deviation', 'stop-loss-position-sizing-ulcer-index-drawdown'],
    'fibonacci-calculator': ['fibonacci-retracement-trading-guide', 'fibonacci-extensions-profit-targets', 'fibonacci-fan-trend-speed', 'fibonacci-arcs-curved-support-zones', 'fibonacci-time-zones-trend-reversal', 'fibonacci-retracement-bear-market', 'fibonacci-spirals-golden-ratio-turn-points', 'how-to-draw-fibonacci-extensions', 'how-to-draw-fibonacci-extensions-downtrend', 'how-to-draw-fibonacci-fans-trend-speed', 'how-to-draw-fibonacci-arcs-curved-support', 'how-to-draw-fibonacci-time-zones', 'how-to-draw-fibonacci-retracements-bear-market', 'how-to-draw-fibonacci-fans-downtrend', 'how-to-draw-fibonacci-fans-bull-market', 'how-to-draw-fibonacci-fans-downtrend-resistance'],
