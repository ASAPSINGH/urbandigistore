...
TOOL_BLOG_MAPPING = {
    ...
    'image-to-pdf': ['how-to-merge-pdf-documents-locally', 'how-to-split-pdf-pages-locally', 'image-compilation-to-pdf-aspect-ratios-alignment', 'how-to-convert-jpg-to-pdf-page-compilation', 'how-to-convert-png-to-pdf-document-compilation', 'how-to-convert-webp-to-pdf-document-compilation', 'how-to-convert-svg-to-pdf-vector-compilation', 'how-to-convert-bmp-to-pdf-document-compilation', 'how-to-convert-tiff-to-pdf-document-compilation', 'how-to-convert-gif-to-pdf-document-compilation']
}
