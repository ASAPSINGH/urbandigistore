...
TOOL_BLOG_MAPPING = {
    ...
    'position-calculator': ['stop-loss-sizing-portfolio-risk-two-percent', 'stop-loss-sizing-average-true-range-atr', 'stop-loss-options-premium-volatility', 'stop-loss-position-sizing-atr-multipliers', 'stop-loss-sizing-volatility-adjusted-atr', 'stop-loss-position-sizing-maximum-drawdown', 'stop-loss-position-sizing-kelly-criterion', 'stop-loss-position-sizing-vix-volatility', 'stop-loss-position-sizing-sharpe-ratio', 'stop-loss-position-sizing-sharpe-sortino', 'stop-loss-position-sizing-ulcer-index', 'stop-loss-position-sizing-sortino-deviation', 'stop-loss-position-sizing-ulcer-index-drawdown', 'stop-loss-position-sizing-volatility-atr-calculations', 'stop-loss-position-sizing-maximum-drawdown-thresholds'],
