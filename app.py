...
TOOL_BLOG_MAPPING = {
    ...
    'position-calculator': ['stop-loss-sizing-portfolio-risk-two-percent', 'stop-loss-sizing-average-true-range-atr', 'stop-loss-options-premium-volatility', 'stop-loss-position-sizing-atr-multipliers', 'stop-loss-sizing-volatility-adjusted-atr', 'stop-loss-position-sizing-maximum-drawdown', 'stop-loss-position-sizing-kelly-criterion', 'stop-loss-position-sizing-vix-volatility', 'stop-loss-position-sizing-sharpe-ratio', 'stop-loss-position-sizing-sharpe-sortino', 'stop-loss-position-sizing-ulcer-index', 'stop-loss-position-sizing-sortino-deviation', 'stop-loss-position-sizing-ulcer-index-drawdown', 'stop-loss-position-sizing-volatility-atr-calculations', 'stop-loss-position-sizing-maximum-drawdown-thresholds', 'stop-loss-position-sizing-sharpe-sortino-allocations', 'stop-loss-position-sizing-leveraged-margin-liquidation'],
    ...
    'pdf-to-image': ['how-to-merge-pdf-documents-locally', 'how-to-split-pdf-pages-locally', 'pdf-page-rendering-rasterizing-canvas-images', 'how-to-convert-pdf-to-jpg-page-extraction'],
    'image-to-pdf': ['how-to-merge-pdf-documents-locally', 'how-to-split-pdf-pages-locally', 'image-compilation-to-pdf-aspect-ratios-alignment', 'how-to-convert-jpg-to-pdf-page-compilation']
}
