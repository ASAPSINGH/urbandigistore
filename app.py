...
TOOL_BLOG_MAPPING = {
    ...
    'pdf-to-image': ['how-to-merge-pdf-documents-locally', 'how-to-split-pdf-pages-locally', 'pdf-page-rendering-rasterizing-canvas-images', 'how-to-convert-pdf-to-jpg-page-extraction', 'how-to-convert-pdf-to-png-transparent-extraction', 'how-to-convert-pdf-to-webp-web-optimized-extraction', 'how-to-convert-pdf-to-svg-vector-graphics-extraction'],
    'image-to-pdf': ['how-to-merge-pdf-documents-locally', 'how-to-split-pdf-pages-locally', 'image-compilation-to-pdf-aspect-ratios-alignment', 'how-to-convert-jpg-to-pdf-page-compilation', 'how-to-convert-png-to-pdf-document-compilation', 'how-to-convert-webp-to-pdf-document-compilation', 'how-to-convert-svg-to-pdf-vector-compilation']
}
