...
TOOL_BLOG_MAPPING = {
    ...
    'pdf-to-image': ['how-to-merge-pdf-documents-locally', 'how-to-split-pdf-pages-locally', 'pdf-page-rendering-rasterizing-canvas-images', 'how-to-convert-pdf-to-jpg-page-extraction', 'how-to-convert-pdf-to-png-transparent-extraction', 'how-to-convert-pdf-to-webp-web-optimized-extraction', 'how-to-convert-pdf-to-svg-vector-graphics-extraction', 'how-to-convert-pdf-to-bmp-uncompressed-extraction', 'how-to-convert-pdf-to-tiff-multipage-extraction', 'how-to-convert-pdf-to-gif-web-optimized-extraction', 'how-to-convert-pdf-to-ico-favicon-extraction'],
    'image-to-pdf': ['how-to-merge-pdf-documents-locally', 'how-to-split-pdf-pages-locally', 'image-compilation-to-pdf-aspect-ratios-alignment', 'how-to-convert-jpg-to-pdf-page-compilation', 'how-to-convert-png-to-pdf-document-compilation', 'how-to-convert-webp-to-pdf-document-compilation', 'how-to-convert-svg-to-pdf-vector-compilation', 'how-to-convert-bmp-to-pdf-document-compilation', 'how-to-convert-tiff-to-pdf-document-compilation', 'how-to-convert-gif-to-pdf-document-compilation', 'how-to-convert-ico-to-pdf-catalog-compilation']
}
